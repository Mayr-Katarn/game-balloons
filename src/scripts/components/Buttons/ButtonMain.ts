...
export default class ButtonMain {
  ...
  private create(): void {
    ...
    this.btn = this.scene.add.sprite(this.x, this.y, sprite).setScale(this.btnScale).setDepth(5).setTint(0xa5c4fb).setInteractive()
  ...
  public setY(y: number): this {
    this.y = y
    this.elements.forEach(el => el.setY(y))
    return this
  }
